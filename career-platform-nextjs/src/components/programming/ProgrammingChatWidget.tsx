  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
      {open && (
        <div
          className={cn(
            'flex h-[420px] w-[min(400px,calc(100vw-2rem))] flex-col overflow-hidden rounded-xl border border-gray-200 bg-white shadow-xl',
        ...
        >
          <div className="flex items-center justify-between border-b border-gray-200 bg-gray-50 px-4 py-3 dark:border-gray-700 dark:bg-gray-800/80">
            <span className="font-semibold text-gray-900 dark:text-gray-100">プログラミング相談</span>
            <Button
              variant="ghost"
              size="icon"
              className="h-8 w-8"
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            ...
            {loading && (
              <div className="mr-auto max-w-[85%] rounded-lg bg-gray-100 px-3 py-2 text-sm text-gray-500 dark:bg-gray-800 dark:text-gray-400">
                考え中…
              </div>
            )}
